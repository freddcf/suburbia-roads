...
interface SkateboardDocumentData {
   ...
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  customizer_link: prismic.Repeatable<
    prismic.LinkField<string, string, unknown, prismic.FieldState, never>
  >;

  /**
   * mostLiked field in *Skateboard*
   *
   * - **Field Type**: Number
   * - **Placeholder**: *None*
   * - **API ID Path**: skateboard.mostliked
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#number
   */
  mostliked: prismic.NumberField;
}
...
export interface HeroSliceDefaultPrimary {
  ...
  /**
   * Skateboard Truck Texture field in *Hero → Default → Primary*
   *
   * - **Field Type**: Color
   * - **Placeholder**: *None*
   * - **API ID Path**: hero.default.primary.skateboard_truck_texture
   * - **Documentation**: https://prismic.io/docs/field#color
   */
  skateboard_truck_texture: prismic.ColorField;

  /**
   * Skateboard Bolt Texture field in *Hero → Default → Primary*
   *
   * - **Field Type**: Color
   * - **Placeholder**: *None*
   * - **API ID Path**: hero.default.primary.skateboard_bolt_texture
   * - **Documentation**: https://prismic.io/docs/field#color
   */
  skateboard_bolt_texture: prismic.ColorField;
}
