    ...
    <div className="skater group relative flex flex-col items-center gap-4">
      <div className="stack-layout overflow-hidden">
        <PrismicNextImage
          ...
          imgixParams={{ q: 20 }}
          alt=""
          className="scale-110 transform transition-all duration-1000 ease-in-out 
          group-hover:scale-100 group-hover:brightness-75 group-hover:saturate-[.8]"
        />
        ...
        <h3
          className="relative grid place-self-end justify-self-start p-2 font-ant 
        text-brand-gray ~text-3xl/4xl"
        >
